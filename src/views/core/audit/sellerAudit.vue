<template>
  <div class="app-container">
    ...
    <el-table :data="list" stripe>
      ...
      <el-table-column prop="contactsMobile" label="联系人手机号" />
      <el-table-column prop="contactsRelation" label="联系人关系" />
      ...
      <el-table-column label="操作" width="200" align="center">
        <template slot-scope="scope">
          <router-link :to="'/core/audit/detail/' + scope.row.id">
...
<script>
import sellerAuditApi from '@/api/core/seller-audit'
