...
export const constantRoutes = [
...

  {
    ...
    children: [
      {
        path: 'buyer',
        name: 'coreBuyerInfoList',
        component: () => import('@/views/core/user-info/buyer'),
        meta: { title: '买家列表' }
      },
      {
        path: 'seller',
        name: 'coreSellerInfoList',
        component: () => import('@/views/core/user-info/seller'),
        meta: { title: '卖家列表' }
      }
    ]
  },

  {
    ...
    component: Layout,
    name: 'coreBorrower',
    meta: { title: '店铺管理', icon: 'el-icon-s-unfold' },
    alwaysShow: true,
    children: [
      {
        path: 'list',
